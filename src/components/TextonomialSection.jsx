      ...
      <section className="section testimonial-section" style={{ flexDirection: 'row' }}>
        ...
        <div className="text-container">
          ...
          <p className="section-text">
            أهالي كتير مبسوطين من المكان! الأولاد بقي عندهم شغف يتعلموا حاجات جديدة زي البرمجة، الإلكترونيات، والأنشطة العملية. الجو هنا ممتع والمدرسين دايمًا بيشجعوا الأطفال على الإبداع وتطوير مهاراتهم بثقة.
          </p>
        </div>
